...
| `01-plan/ruta_de_trabajo.md` | Ruta paso a paso de todo el proyecto: etapas 0-5, qué está hecho y qué sigue | **Punto de entrada operativo.** Si el jugador pregunta "¿qué hago ahora?", la respuesta está aquí |
...
- ✅ **Migración clicker → keybinder COMPLETADA (2026-09-12).** Las habilidades de reacción salen por tecla (trinket y Cyclone @focus en los laterales del ratón, Bear+Frenzied en F, Barkskin en D, Ironbark en A, Shadowmeld en V, Roots en Shift+D, Wild Charge en R, Cyclone @arena en Ctrl+1/2/3). **Las curas base 1-5 siguen clickeadas a propósito.** Mapa completo en `02-configuracion/macros_y_ui.md`.
