...
| `01-plan/roadmap_fases.md` | Plan de entrenamiento en 5 fases (0-4) con métricas de salida | La columna vertebral; sincronizado 2026-07-12 con los archivos de detalle |
| `02-configuracion/macros_resto_druid.md` | Las 11 macros obligatorias + opcionales, keybinds, drill | Fuente de verdad de macros (detalle de Fase 0.3) |
...
| `03-talentos/talentos_core.md` | Los 12 talentos 48-50/50 que requieren decisión activa | Referencia estable dentro de S1 |
